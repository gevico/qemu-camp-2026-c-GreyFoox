...
int main(void) {
    ...
    uint16_t version_val = be16_to_cpu(raw.version_raw);
    unsigned ver_major = (version_val >> 4) & 0x0Fu;
    unsigned ver_minor = version_val & 0x0Fu;
